...
1. Workflow We are now happy to announce that we have made a successful integration with the company [postofixe](https://www.postofixe.com/). Here is how to achieve the whole integration. (You can ***right-click the picture*** to open a new page to view the large one.)
![](https://qhstatic-us-s3.coohom.com/image/png/1749115093892/A8CEBABD0663ECBAEEE7516DF7A7D2B5.png)
