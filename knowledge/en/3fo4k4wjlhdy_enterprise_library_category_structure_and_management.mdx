...
1. Enter the whole house customization Merchant management-whole house furniture customization (the operation steps of cabinet customization and whole house furniture customization are the same)

2. Model category analysis 2.1 Material library: used to store uploaded texture maps, suitable for flat materials, mixed materials, etc. Common materials include plates, stones, glass mirrors, leather, fabrics, metals, wall coverings, etc. 2.1.1 Upload entrance of texture map: whole house furniture customization-upload material-texture map 2.1.2 There are three levels of material library categories, as shown in the figure below, the third level directory cannot create new subdirectories.
